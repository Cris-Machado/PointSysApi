...
{
    public class UsersPointRepository : RepositoryBase<UserPoint>, IUsersPointRepository
    {
        private readonly ILogger<UsersPointRepository> _logger;
        public UsersPointRepository(IDbContext context, ILogger<UsersPointRepository> logger) : base(context)
        {
            _logger = logger;
        }
